...
public class TemplateHandler {
    ...
    private void loadTemplates() {
        List<String> templateNames = List.of(
                "templates/reference001/reference-001-branch-template.docx",
                "templates/reference001/reference-001-mobile-template.docx",
                "templates/reference001/reference-001-online-template.docx"
        );
